            ...
            <div className="mb-8">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-blue-700">{config.labels.aiLabel} Summary</span>
              ...
              {summaryOpen && (
                <div className="px-4 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 border-t-0 rounded-b-xl">
                  ...
                  <p className="text-xs text-blue-400 mt-4">Generated by {config.labels.aiLabel} · Always consult a healthcare professional</p>
                </div>
              )}
            </div>
